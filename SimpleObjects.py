...
class Pipe(GenericObject):
    ...
    Couldn't get this to work as I had attempted to do it by 3D
    coordinate rotation rather than projecting points onto the 
    plane of reflection, but it because obvious at some point
    that this was actually necessary. And unfortunately it's
    to late to do it that way now.
    '''
